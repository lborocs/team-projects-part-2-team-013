...
export function generateAvatarSvg(text, colour) {
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="256px" height="256px" viewBox="0 0 256 256" version="1.1">
        ...
        <text xmlns="http://www.w3.org/2000/svg" style="color: #000; line-height: 1; font-family: system-ui" alignment-baseline="middle" text-anchor="middle" font-size="140" font-weight="600" dy=".1em" dominant-baseline="middle" fill="#000" x="50%" y="50%">${text}</text>
    </svg>`
}
